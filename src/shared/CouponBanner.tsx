...
export default function WelcomeCouponBanner() {
  ...
  const title = coupon.label?.title?.[lang] || coupon.label?.title?.en || t("defaultTitle", "Welcome Coupon!");
  const desc = coupon.label?.description?.[lang] || coupon.label?.description?.en || t("defaultDesc", "Enjoy your special welcome discount!");
