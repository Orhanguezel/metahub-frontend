...
import type { CompanyLogo, CompanyFormValues } from "@/modules/company/types/company";
...
export default function FooterSection({ company }: FooterSectionProps) {
  ...
  // type-safe logos
  const logos: CompanyLogo[] = Array.isArray(company.logos) ? company.logos : [];
...
const Logo = styled.img`
  ...
  object-fit: contain;
  background: ${({ theme }) => theme.colors.backgroundAlt}; // tema ile uyumlu arka plan
