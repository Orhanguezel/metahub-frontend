...
export default function NewsCategoryForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!mainName.trim()) {
      alert(t("admin.newscategory.name_required", "Category name required"));
      return;
    }
        ...
        {SUPPORTED_LOCALES.map((lng) => (
          <div key={lng}>
            ...
            <input
              ...
              required={lng === lang}
              placeholder={t("admin.newscategory.name_placeholder", "Enter name")}
              autoFocus={lng === lang}
            />
            ...
            <textarea
              ...
              placeholder={t("admin.newscategory.desc_placeholder", "Optional")}
            />
          </div>
        ))}
