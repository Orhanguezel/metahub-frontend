...
const TABS: Array<{
  ...
  { key: "list", labelKey: "tabs.articles", fallback: "Articles" },
  { key: "create", labelKey: "tabs.create", fallback: "New Articles" },
...
export default function ArticlesTabs({ activeTab, onChange }: Props) {
  ...
  return (
    <Header role="tablist" aria-label="Articles Management Tabs">
      {TABS.map((tab, idx) => (
        <TabButton
  key={tab.key}
