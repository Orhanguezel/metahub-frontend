  ...
  return (
    <FormWrapper>
      ...
      <form onSubmit={handleSubmit}>
        {LANGUAGES.map((lng) => (
          <div key={lng}>
            <label htmlFor={`name-${lng}`}>
              {t("admin.ensotekprodcategory.name", "Category Name")} ({lng.toUpperCase()})
            </label>
            <input
              id={`name-${lng}`}
              type="text"
            ...
            <label htmlFor={`desc-${lng}`}>
              {t("admin.ensotekprodcategory.description", "Description")} ({lng.toUpperCase()})
            </label>
            <textarea
              id={`desc-${lng}`}
        ...
        <label>{t("admin.ensotekprodcategory.image", "Images")}</label>
