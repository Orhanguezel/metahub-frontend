...
import type { CompanyFormValues, CompanyLogo } from "@/modules/company/types/company";
...
export default function CompanyForm({ initialValues, onSubmit }: Props) {
  ...
  const [existingImages, setExistingImages] = useState<string[]>(getUrlArray(initialValues.logos));
  ...
  return (
    <FormStyled onSubmit={formik.handleSubmit} autoComplete="off" noValidate>
      ...
      />
      <FieldError>{formik.touched.address?.street && (formik.errors.address as any)?.street}</FieldError>
      ...
      />
      <FieldError>{formik.touched.address?.city && (formik.errors.address as any)?.city}</FieldError>
      ...
      />
      <FieldError>{formik.touched.address?.postalCode && (formik.errors.address as any)?.postalCode}</FieldError>
      ...
      />
      <FieldError>{formik.touched.address?.country && (formik.errors.address as any)?.country}</FieldError>
      ...
      />
      <FieldError>{formik.touched.bankDetails?.bankName && (formik.errors.bankDetails as any)?.bankName}</FieldError>
      ...
      />
      <FieldError>{formik.touched.bankDetails?.iban && (formik.errors.bankDetails as any)?.iban}</FieldError>
      ...
      />
      <FieldError>{formik.touched.bankDetails?.swiftCode && (formik.errors.bankDetails as any)?.swiftCode}</FieldError>

      <SectionTitle>{t("socialMedia", "Social Media Accounts")}</SectionTitle>
      <Label htmlFor="socialLinks.facebook">Facebook</Label>
      <Input id="socialLinks.facebook" name="socialLinks.facebook" value={formik.values.socialLinks.facebook} onChange={formik.handleChange} />
      <Label htmlFor="socialLinks.instagram">Instagram</Label>
      <Input id="socialLinks.instagram" name="socialLinks.instagram" value={formik.values.socialLinks.instagram} onChange={formik.handleChange} />
      <Label htmlFor="socialLinks.twitter">Twitter</Label>
      <Input id="socialLinks.twitter" name="socialLinks.twitter" value={formik.values.socialLinks.twitter} onChange={formik.handleChange} />
      <Label htmlFor="socialLinks.linkedin">LinkedIn</Label>
      <Input id="socialLinks.linkedin" name="socialLinks.linkedin" value={formik.values.socialLinks.linkedin} onChange={formik.handleChange} />
      <Label htmlFor="socialLinks.youtube">YouTube</Label>
      <Input id="socialLinks.youtube" name="socialLinks.youtube" value={formik.values.socialLinks.youtube} onChange={formik.handleChange} />
