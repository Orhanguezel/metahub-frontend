...
const TABS: Array<{
  ...
  { key: "list", labelKey: "tabs.pricing", fallback: "Pricing" },
  { key: "create", labelKey: "tabs.create", fallback: "New Pricing" },
];
...
export default function PricingTabs({ activeTab, onChange }: Props) {
  ...
  return (
    <Header role="tablist" aria-label="Pricing Management Tabs">
      {TABS.map((tab, idx) => (
        <TabButton
          key={tab.key}
