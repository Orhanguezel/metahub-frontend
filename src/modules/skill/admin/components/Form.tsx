...
import type { ISkill, SkillCategory, ISkillImage } from "@/modules/skill/types";
...
export default function SkillForm({ categories, initial, onSubmit, onCancel, onAddCategory }: Props) {
  ...
  const originalExisting = useMemo<ISkillImage[]>(
    () => ((initial?.images || []) as ISkillImage[]),
    [initial?.images]
  );
