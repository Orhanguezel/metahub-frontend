...
import { fetchReferences, fetchReferenceBySlug } from "@/modules/references/slice/referencesSlice";
...
export default function ReferenceDetailSection() {
  ...
  const others = (referenceList ?? []).filter((item) => item.slug !== slug).slice(0, 2);
