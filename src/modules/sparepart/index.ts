...
// Public Components
export { default as SparepartSection } from "./public/components/Section";
export { default as DetailSection } from "./public/components/DetailSection";

// Redux Slice
export { default as sparepartCategoryReducer } from "./slice/sparepartCategorySlice";
export { default as sparepartReducer } from "./slice/sparepartSlice";
