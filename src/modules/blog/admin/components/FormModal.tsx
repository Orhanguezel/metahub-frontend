...
export default function FormModal({
  ...
  // --- STATE ---
 // Sadece selector!
  const categories = useAppSelector((state) => state.blogCategory.categories);
  const successMessage = useAppSelector((state) => state.blog.successMessage);
 ...
 useEffect(() => {
  ...
  return (
    <FormWrapper>
      <h2>
        {editingItem
          ? t("admin.blog.edit", "Edit Blog")
          : t("admin.blog.create", "Create New Blog")}
      </h2>
