// modules/users/ForgotPasswordForm.tsx
"use client";
import { useState, useEffect } from "react";
import { useDispatch, useSelector } from "react-redux";
import { forgotPassword, clearAuthMessages } from "@/modules/users/slice/authSlice";
...
export default function ForgotPasswordForm({ onNext }: Props) {
  ...
  useEffect(() => {
    if (successMessage) {
      ...
      onNext({ step: "done" }); // Stepper'da son adıma geç
    }
    if (error) {
      toast.error(error);
      dispatch(clearAuthMessages());
...
// ...Styled-components tanımları (ChangePassword ile aynı)
