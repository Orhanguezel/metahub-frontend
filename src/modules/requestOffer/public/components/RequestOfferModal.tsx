// src/modules/requestOffer/components/RequestOfferModal.tsx
"use client";
...
export default function RequestOfferModal({ open, onClose }: { open: boolean; onClose: () => void }) {
      ...
      >
        ...
        {sent ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Textarea placeholder={t("form.message", "İstediğiniz ürün/hizmet ve ek notunuz...")} />
