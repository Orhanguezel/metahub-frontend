...
const TABS: Array<{
  ...
  { key: "list", labelKey: "tabs.massage", fallback: "Massage" },
  { key: "create", labelKey: "tabs.create", fallback: "New Massage" },
...
export default function MassageTabs({ activeTab, onChange }: Props) {
  ...
  return (
    <Header role="tablist" aria-label="Massage Management Tabs">
      {TABS.map((tab, idx) => (
        <TabButton
  key={tab.key}
