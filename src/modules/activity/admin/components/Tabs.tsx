...
const TABS: Array<{
  ...
  { key: "list", labelKey: "tabs.activity", fallback: "Activity" },
  { key: "create", labelKey: "tabs.create", fallback: "New Activity" },
...
export default function ActivityTabs({ activeTab, onChange }: Props) {
  ...
  return (
    <Header role="tablist" aria-label="Activity Management Tabs">
      {TABS.map((tab, idx) => (
        <TabButton
  key={tab.key}
