  ...
  return (
    <FormWrapper>
      ...
      <form onSubmit={handleSubmit}>
        {SUPPORTED_LOCALES.map((lng) => (
          <div key={lng}>
            <label htmlFor={`title-${lng}`}>
              {t("admin.team.title", "Title")} ({lng.toUpperCase()})
            </label>
            <input
              id={`title-${lng}`}
              value={titles[lng]}
            ...
            <label htmlFor={`summary-${lng}`}>
              {t("admin.team.summary", "Summary")} ({lng.toUpperCase()})
            </label>
            <textarea
              id={`summary-${lng}`}
              value={summaries[lng]}
            ...
            <label htmlFor={`content-${lng}`}>
              {t("admin.team.content", "Content")} ({lng.toUpperCase()})
            </label>
            <textarea
              id={`content-${lng}`}
              value={contents[lng]}
        ...
        <label>{t("admin.team.image", "Images")}</label>
