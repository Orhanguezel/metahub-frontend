  ...
  if (!Array.isArray(team) || team.length === 0) {
    return (
      <Section>
        <TeamGrid>
          <Left>
            <MainTitle>{t("page.team.title", "Bizden Haberler")}</MainTitle>
            <Desc>{t("page.team.noTeam", "Haber bulunamadı.")}</Desc>
            <SeeAllBtn href="/team">
              {t("page.team.all", "Tüm Haberler")}
            </SeeAllBtn>
          </Left>
        </TeamGrid>
      </Section>
  ...
  return (
    ...
    >
      <TeamGrid>
        {/* SOL BLOK */}
        <Left>
          <MinorTitle>{t("page.team.minorTitle", "NEWS")}</MinorTitle>
          <StyledLink
            href={`/team/${main.slug}`}
            aria-label={getTitle(main, lang) || "Untitled"}
          >
            {getTitle(main, lang) || t("page.team.title", "Bizden Haberler")}
          </StyledLink>
          <Desc>
