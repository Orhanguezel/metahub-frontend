...
const TABS: Array<{
  ...
  { key: "list", labelKey: "tabs.about", fallback: "About" },
  { key: "create", labelKey: "tabs.create", fallback: "New About" },
...
export default function AboutTabs({ activeTab, onChange }: Props) {
  ...
  return (
    <Header role="tablist" aria-label="About Management Tabs">
      {TABS.map((tab, idx) => (
        <TabButton
  key={tab.key}
