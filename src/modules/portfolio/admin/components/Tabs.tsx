...
const TABS: Array<{
  ...
  { key: "list", labelKey: "tabs.portfolio", fallback: "Portfolio" },
  { key: "create", labelKey: "tabs.create", fallback: "New Portfolio" },
];
...
export default function PortfolioTabs({ activeTab, onChange }: Props) {
  ...
  return (
    <Header role="tablist" aria-label="Portfolio Management Tabs">
      {TABS.map((tab, idx) => (
        <TabButton
          key={tab.key}
